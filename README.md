...
```
npm create cloudflare@latest -- --template=cloudflare/templates/arogrs0-gif
```

A live public deployment of this template is available at [https://arogrs0-gif.templates.workers.dev](https://arogrs0-gif.templates.workers.dev)
